...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>Students Semester Two Marks</h5>
                </div>
                <div class="col-sm-6">
                    ...
                    @if(count($twos))
                        ...
                        <div class="card-header no-print">
                            ...
                            <h3 class="card-title pull-left">
                                Showing <strong>{{ count($twos) }}</strong> records
                                of <strong>{{ $twos->total() }}</strong></h3>
                        ...
                        <div class="card-body">
                            <div class="col-12 table-responsive">
                                <form action="{{ route('semester.two') }}" method="post">
                                    @csrf
                            ...
                            <div class="card-header no-print">
                                <h3 class="card-title pull-left">Showing <strong>{{ count($twos) }}</strong>
                                    records
                                    of <strong>{{ $twos->total() }}</strong></h3>
                                <ul class="pagination pagination-sm m-0 float-right">
                                    {{ $twos->links() }}
